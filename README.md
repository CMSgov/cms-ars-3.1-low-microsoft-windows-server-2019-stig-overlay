...
bundle install
cd ..
inspec exec cms-ars-3.1-low-microsoft-windows-server-2019-stig-overlay --input-file <path_to_your_input_file/name_of_your_input_file.yml> cms-ars-3.1-low-microsoft-windows-server-2019-stig-overlay/static-inputs.yml -t winrm://<hostname> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
